#include<windows.h>
#include<conio.h>
int T, X, Y, c = 0, i, j, k, map[250] = {0}, node[28][4] = {
    -1，0，1，-11，10，0，-10，-9，11，-1，0，1，9，10，0，-10，
    -1，0，1，-9，10，11，0，-10，9，-1，0，1，10，0，-10，-11，
    9，10，0，1，11，0，1，-10，9，10，0，1，11，0，1，-10，
    10，11，-1，0，10，0，1，-9，10，11，-1，0，10，0，1，-9，
    -1，0，1，-10，10，0，1，-10，10，-1，0，1，10，-1，0，-10，
    20，10，0，-10，-1，0，1，2，20，10，0，-10，-1，0，1，2，
    10，11，0，1，10，11，0，1，10，11，0，1，10，11，0，1
}；//7种形状，4个方向，4个节点

int move (int *v, int l) {
    for (*v += 1, i = 0; i < 4 && (j = (node[T][I] + 11) % 10 - 1 + X, 1); i++) {
        if (j < 0 || 9 < j || 24 < (node[T][i] + 11) / 10 - 1 + Y) ||
        map[node[T][i] + Y * 10 + X] && (*v -= 1, 1))return 0;
    }
}
...
void down() {
    ...
    for (i = 250, k = 0; i > 9 || (c = 0); i % 10 == 0 && (k = 0))
        if (--i, (k += map[i]) == 10)
