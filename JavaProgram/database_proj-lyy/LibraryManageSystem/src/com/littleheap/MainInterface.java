...
import com.littleheap.Manager.deleteLibrary;
import com.littleheap.Manager.insertLibrary;
import com.littleheap.Manager.updateLibrary;
...
import com.littleheap.User.libraryin;
import com.littleheap.User.personalin;
...
public class MainInterface extends JFrame implements ActionListener{
	...
	public static insertLibrary insertLibraryJPanel = new insertLibrary();
	public static updateLibrary updateLibraryJPanel = new updateLibrary();
	public static deleteLibrary deleteLibraryJPanel = new deleteLibrary();
	...
	public static personalin personalinJPanel = new personalin();
	public static libraryin libraryinJPanel = new libraryin();
	...
	private static boolean flage_personalin = false;
	private static boolean flage_libraryin = false;
	private static boolean flage_insertLibrary = false;
	private static boolean flage_updateLibrary = false;
	private static boolean flage_deleteLibrary = false;
	...
	//Manager->InsertLibrary
	public static void ManagertoInsertLibrary() {
		if(!flage_insertLibrary) {
			managerJPanel.setVisible(false);
			container.add(insertLibraryJPanel);
			flage_state = true;
		}else {
			managerJPanel.setVisible(false);
			insertLibraryJPanel.setVisible(true);
		}
	}

	//InsertLibrary->Manager
	public static void InsertLibrarytoManager() {
		insertLibraryJPanel.setVisible(false);
		managerJPanel.setVisible(true);
	}

	//Manager->UpdateLibrary
	public static void ManagertoUpdateLibrary() {
		if(!flage_updateLibrary) {
			managerJPanel.setVisible(false);
			container.add(updateLibraryJPanel);
			flage_state = true;
		}else {
			managerJPanel.setVisible(false);
			updateLibraryJPanel.setVisible(true);
		}
	}

	//UpdateLibrary->Manager
	public static void UpdateLibrarytoManager() {
		updateLibraryJPanel.setVisible(false);
		managerJPanel.setVisible(true);
	}

	//Manager->DeleteLibrary
	public static void ManagertoDeleteLibrary() {
		if(!flage_deleteLibrary) {
			managerJPanel.setVisible(false);
			container.add(deleteLibraryJPanel);
			flage_state = true;
		}else {
			managerJPanel.setVisible(false);
			deleteLibraryJPanel.setVisible(true);
		}
	}

	//DeleteLibrary->Manager
	public static void DeleteLibrarytoManager() {
		deleteLibraryJPanel.setVisible(false);
		managerJPanel.setVisible(true);
	}
	...
	//User->Personalin
	public static void UsertoPersonalin() {
			if(!flage_personalin) {
				userJPanel.setVisible(false);
				container.add(personalinJPanel);
				flage_personalin = true;
			}else {
				userJPanel.setVisible(false);
				personalinJPanel.setVisible(true);
			}
		}
		
	//Personalin->User
	public static void PersonalintoUser() {
			personalinJPanel.setVisible(false);
			userJPanel.setVisible(true);
		}

//add	//User->libraryin
	public static void UsertoLibraryin() {
			if(!flage_libraryin) {
				userJPanel.setVisible(false);
				container.add(libraryinJPanel);
				flage_libraryin = true;
			}else {
				userJPanel.setVisible(false);
				libraryinJPanel.setVisible(true);
			}
		}
		
	//Libraryin->User
	public static void LibraryintoUser() {
		libraryinJPanel.setVisible(false);
		userJPanel.setVisible(true);
	}
