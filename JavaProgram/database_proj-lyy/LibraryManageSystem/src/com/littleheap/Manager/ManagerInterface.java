...
public class ManagerInterface extends JPanel implements ActionListener{
	...
	private JButton btn_insertLibrary;
	private JButton btn_updateLibrary;
	private JButton btn_deleteLibrary;
	...
	public ManagerInterface() {
		...
		btn_insertLibrary = new JButton("\u66F4\u65B0\u4FE1\u606F");
		btn_insertLibrary.setFont(new Font("宋体", Font.BOLD, 40));
		btn_insertLibrary.setBounds(673, 241, 280, 505);
		add(btn_insertLibrary);
		btn_insertLibrary.addActionListener(this);

		btn_updateLibrary = new JButton("\u66F4\u65B0\u4FE1\u606F");
		btn_updateLibrary.setFont(new Font("宋体", Font.BOLD, 40));
		btn_updateLibrary.setBounds(673, 241, 280, 505);
		add(btn_updateLibrary);
		btn_updateLibrary.addActionListener(this);

		btn_deleteLibrary = new JButton("\u66F4\u65B0\u4FE1\u606F");
		btn_deleteLibrary.setFont(new Font("宋体", Font.BOLD, 40));
		btn_deleteLibrary.setBounds(673, 241, 280, 505);
		add(btn_deleteLibrary);
		btn_deleteLibrary.addActionListener(this);
	...
	public void actionPerformed(ActionEvent e) {
		...
		else if(e.getSource() == btn_insertLibrary) {
			MainInterface.ManagertoInsertLibrary();
		}
		else if(e.getSource() == btn_updateLibrary) {
			MainInterface.ManagertoUpdateLibrary();
		}
		else if(e.getSource() == btn_deleteLibrary) {
			MainInterface.ManagertoDeleteLibrary();
		}
